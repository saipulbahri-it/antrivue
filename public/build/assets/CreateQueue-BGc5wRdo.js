import{_ as a}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c,o as s,e as i,j as u,t as d}from"./app-DjmU4WO1.js";const p={data(){return{ticket:null}},methods:{async create(){const e=await fetch("/api/queues",{method:"POST"});this.ticket=await e.json()},printTicket(){const e=window.open("","","width=300,height=600");e.document.write(`
