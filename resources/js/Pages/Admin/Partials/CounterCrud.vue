                ...
                <div class="inline-flex flex-col gap-2">
                    <IftaLabel class="w-full md:w-56">
                        <Select
                            ...
                            :invalid="form.errors.service_id ? true : false"
                            class="w-full"
                            :variant="form.service_id ? 'filled' : 'outlined'"
                        />
                ...
                <div class="inline-flex w-full flex-col gap-2">
                    <FloatLabel variant="in">
                        <InputText
                            ...
                            :invalid="form.errors.ip_address ? true : false"
                            :variant="form.ip_address ? 'filled' : 'outlined'"
                            fluid
                        />
